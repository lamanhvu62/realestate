...
import banner from "../../public/banner-citigrand.jpg";
  ...
  return (
    <div className="relative h-screen overflow-hidden">
      <div className="absolute -z-10 bottom-0">
        <Image src={banner} alt="Citi Grand" />
      </div>
      <div className="w-full h-full flex items-center justify-end pr-5 z-20">
        <div className="w-4/12 bg-white rounded flex relative">
          ...
          <div className="p-3 border-l w-10/12">
            <p className="text-slate-600 mb-6">
              ...
              100 Võ Chí Công, Thạch Mỹ Lợi, Tp Thủ Đức, Hồ Chí Minh
            </p>
            <h2 className="text-3xl font-bold text-yellow-400 mb-4">
              Thủ Thiêm Green House
            </h2>
            <p className="mb-4 text-slate-600">
              Là dự án của Chủ đầu tư Thủ Thiêm Group xây dựng và phát triển
              theo định hướng của chính phủ hướng đến phân khúc thấp phù hợp với
              khách hàng có mức thu nhấp trung bình và thấp chỉ với 25 triệu/m2.
            </p>
            <div className="flex justify-between items-center">
              <p className="text-slate-600 text-2xl font-semibold">
                <Sell style={{ fontSize: "26px", color: "#facc15" }} />1 tỷ 745
                triệu VND
              </p>
              <Button
                variant="contained"
